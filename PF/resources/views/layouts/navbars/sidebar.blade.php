...
{{--      </li>--}}
      <!-- modulos -->
      <li class="nav-item{{ $activePage == 'medicamentos' ? ' active' : '' }}">
        <a class="nav-link" href="{{ route('medicamentos') }}">
          <i class="material-icons">content_paste</i>
          <p>{{ __('Medicamentos') }}</p>
        </a>
      </li>
      <li class="nav-item{{ $activePage == 'enfermedads' ? ' active' : '' }}">
        <a class="nav-link" href="{{ route('enfermedads') }}">
          <i class="material-icons">content_paste</i>
          <p>{{ __('Enfermedades') }}</p>
        </a>
      </li>
      ...
      <li class="nav-item{{ $activePage == 'alergias' ? ' active' : '' }}">
        <a class="nav-link" href="{{ route('alergias') }}">
          <i class="material-icons">content_paste</i>
          <p>{{ __('Alergias') }}</p>
        </a>
      </li>
